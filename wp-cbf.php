 ...
 *
 * @link              http://www.pitagorasnet.com.ve
 * @since             1.0.0
 * @package           Wp_Cbf
 *
 * @wordpress-plugin
 * Plugin Name:       WP Cleanup and base functions
 * Plugin URI:        https://github.com/gabrielx3500/wp-cleanup-basics-funcions.git
 * Description:       Este Plugin te permitira optimizar el funcionamiento de tu sitio web.
 * Version:           1.0.0
 * Author:            Gabriel Acosta
 * Author URI:        http://www.pitagorasnet.com.ve
 * License:           GPL-2.0+
